      ...
      <div className="container mx-auto px-6 md:px-12">
        ...
        >
            ...
            {[
              ...
              <motion.div key={item.label} variants={fadeUpVariant}>
                {item.href ? (
                  <a
                    href={item.href}
                    className="group flex flex-col items-center text-center p-8 border border-border bg-card hover:border-primary/50 transition-all duration-300"
                  >
          ...
          <motion.div variants={fadeUpVariant}>
            {submitted ? (
              <div className="bg-gradient-to-br from-primary/10 to-background border border-primary/30 p-12 text-center">
              ...
              <form onSubmit={handleSubmit} className="bg-card border border-border p-8 md:p-12">
                ...
                <button
                  type="submit"
                  className="group inline-flex items-center justify-center gap-2 bg-primary text-primary-foreground px-10 py-4 text-sm font-semibold tracking-wide uppercase transition-all duration-300 hover:bg-primary/90"
                >
                  Send Message
